            ...
            <div class="flex-1 relative">
                <div class="flex items-center">
                    <div class="flex items-center justify-center w-10 h-10 bg-green-500 rounded-full">
                        <span class="flex h-8 w-8 rounded-full bg-green-500 text-white justify-center items-center">
    ...
    <div class="max-w-xl mx-auto">
        <form method="POST" action="{{ route('register.create-account') }}" class="bg-white shadow-lg rounded-2xl p-8">
            ...
            <div class="flex items-center justify-between">
                <a href="{{ route('register') }}" class="inline-flex items-center text-sm text-gray-600 hover:text-gray-900">
