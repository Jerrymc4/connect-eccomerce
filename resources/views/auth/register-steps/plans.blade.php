                    ...
                    <div class="p-6">
                        ...
                        <div class="space-y-4">
                                ...
                                <ul class="space-y-3">
                                    @foreach(json_decode($plan->features) as $feature)
                                        <li class="flex items-start">
                                            <x-icon name="check" class="w-5 h-5 text-primary-500 mt-0.5 mr-3 flex-shrink-0" />
                            ...
                            <div class="space-y-2 text-sm text-gray-600">
                                <div class="flex items-center">
                                    <x-icon name="package" class="h-5 w-5 text-gray-400 mr-2" />
                                    <span>{{ $plan->max_products }} products</span>
                                </div>
                                <div class="flex items-center">
                                    <x-icon name="users" class="h-5 w-5 text-gray-400 mr-2" />
                                    <span>{{ $plan->max_staff_accounts }} staff accounts</span>
                                </div>
                                <div class="flex items-center">
                                    <x-icon name="globe" class="h-5 w-5 text-gray-400 mr-2" />
